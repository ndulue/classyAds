<?php 
  ...
  if (!empty($_GET["edit"])) {
    ...
    header("location:dashboard-ads.php");
  }
  ...
  if ($_SERVER["REQUEST_METHOD"] == "post") {
    ...
    if (!empty($_POST['Pbrand'])) {
      $Pbrand = test_input($_POST['Pbrand']);
    ...
    if (!empty($_POST['Pspec1'])) {
      $Pspec1 = test_input($_POST['Pspec1']);
    ...
    if (!empty($_POST['Pspec2'])) {
      $Pspec2 = test_input($_POST['Pspec2']);
      if (!preg_match('/^[a-zA-Z]*$/', $Pspec2)) {
        $Pspec2_err = "Only alphabet and whitespaces are allowed";
      }
    }else{
       $Pspec2_err = "Enter another specification of your product";
    }

    if (!empty($_POST['Pspec3'])) {
      $Pspec3 = test_input($_POST['Pspec3']);
      if (!preg_match('/^[a-zA-Z]*$/', $Pspec3)) {
        $Pspec3_err = "Only alphabet and whitespaces are allowed";
      }
    }else{
       $Pspec3_err = "Enter another specification of your product";
    }

    if (!empty($_POST['Pspec4'])) {
      $Pspec4 = test_input($_POST['Pspec4']);
      if (!preg_match('/^[a-zA-Z]*$/', $Pspec4)) {
        $Pspec4_err = "Only alphabet and whitespaces are allowed";
      }
    }else{
       $Pspec4_err = "Enter another specification of your product";
    }

    if (!empty($_POST['Pspec5'])) {
      $Pspec5 = test_input($_POST['Pspec5']);
      if (!preg_match('/^[a-zA-Z]*$/', $Pspec5)) {
        $Pspec5_err = "Only alphabet and whitespaces are allowed";
      }
    }else{
       $Pspec5_err = "Enter another specification of your product";
    }

    $sql = "UPDATE `product` SET `product_image`='$upload_path1',`product_image2`='$upload_path2',`product_image3`='upload_path3',`product_category`='$Pcat', `product_name`='$Pname',`product_tag`='$Ptag', `product_description`='$Pdesc', `product_brand`='$Pbrand',`product_price`='$Pprice',`product_spec1`='$Pspec1',`product_spec2`='$Pspec2',`product_spec3`='$Pspec3',`product_spec4`='$Pspec4',`product_spec5`='$Pspec5'";
                      ...
                      <div class="col-md-12">
                        ...
                        ?>
                            <ul class="nav">
                              ...
                              <li><input type="text" name="Pname" value="<?php echo $product_name;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="Item Name"/></li>
                            ...
                            <ul class="nav">
                              ...
                              <li> 
                                <div class="input-group fileupload-v1">
                                  ...
                                  <input type="text" value="<?php echo $product_image;?>" class="form-control fileupload-v1-path" placeholder="1." disabled>
                              ...
                              <li> 
                                <div class="input-group fileupload-v1">
                                  ...
                                  <input type="text" value="<?php echo $product_image2;?>" class="form-control fileupload-v1-path" placeholder="2." disabled>
                                  <span class="input-group-btn">
                                    <button class="btn fileupload-v1-btn" type="button"><i class="fa fa-folder"></i> Choose File</button>
                                  </span>
                                </div>
                              ...
                              <li> 
                                <div class="input-group fileupload-v1">
                                  ...
                                  <input type="text" value="<?php echo $product_image3;?>" class="form-control fileupload-v1-path" placeholder="3." disabled>
                                  <span class="input-group-btn">
                                    <button class="btn fileupload-v1-btn" type="button"><i class="fa fa-folder"></i> Choose File</button>
                                  </span>
                                </div>
                            ...
                            <h4>Product Description:</h4>
                              <div class="col-md-12 padding-0">
                                <textarea class="summernote" value="<?php echo $product_description;?>" name="Pdesc" placeholder="Description.."></textarea>
                                <span class="Pdesc_err"><?php echo $Pdesc_err;?></span>
                              </div>
                            <ul class="nav">
                              <li><h4>Product Tag:</h4></li>
                              <li><input type="text" name="Ptag" value="<?php echo $product_tag;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="eg camera, bag, shoe"/></li>
                              <span class="Ptag_err"><?php echo $Ptag_err;?></span>
                            </ul>
                            <ul class="nav">
                              <li><h4>Product Brand:</h4></li>
                              <li><input type="text" name="Pbrand" value="<?php echo $product_brand;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="Brand"/></li>
                              <span class="Pbrand_err"><?php echo $Pbrand_err;?></span>
                            </ul>
                            <ul class="nav">
                              <li><h4>Product Price:</h4></li>
                              <li><input type="number" value="<?php echo $product_price;?>" name="Pprice" class="txtinput form-control border-bottom box-shadow-none" placeholder="Price"/></li>
                              <span class="Pprice_err"><?php echo $Pprice_err;?></span>
                            </ul>
                            <ul class="nav">
                              <li><h4>Product Specifications:</h4></li>
                              <li><input type="text" name="Pspec1" value="<?php echo $product_spec1;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="1."/></li>
                              <span class="Pspec1_err"><?php echo $Pspec1_err;?></span>
                              <li><input type="text" name="Pspec2" value="<?php echo $product_spec2;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="2."/></li>
                              <span class="Pspec2_err"><?php echo $Pspec2_err;?></span>
                              <li><input type="text" name="Pspec3" value="<?php echo $product_spec3;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="3."/></li>
                              <span class="Pspec3_err"><?php echo $Pspec3_err;?></span>
                              <li><input type="text" name="Pspec4" value="<?php echo $product_spec4;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="4."/></li>
                              <span class="Pspec4_err"><?php echo $Pspec4_err;?></span>
                              <li><input type="text" name="Pspec5" value="<?php echo $product_spec5;?>" class="txtinput form-control border-bottom box-shadow-none" placeholder="5."/></li>
