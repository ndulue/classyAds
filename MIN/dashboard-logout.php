<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      unset($_SESSION['email'], $_SESSION['username'], $_SESSION['id']);
      session_destroy();
      header('location:login.php');
    }
      ...
      <div class="btn-wrapper">
          <div class="panel box-shadow-none content-header">
            <div class="panel-body">
              <div class="col-md-12">
                  <h3 class="animated fadeInLeft">Logout</h3>
              </div>
            </div>
          </div>
                  ...
                  <div class="panel">
                      ...
                      <div class="panel-body">
                          ...
                          <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
                            <button style="margin-top:0px !important;" type="submit" name="logout" id="logout" class="btn-flip btn btn-3d btn-danger">
                              <div class="flip">
                                <div class="side">
                                  Logout <span class="fa fa-location-arrow"></span>
                                </div>
                                <div class="side back">
                                  are you sure?
                                </div>
