                ...
                <div class="col-md-12 mail-right">
                    <div class="col-md-12 mail-right-content">
                        <table class="table table-hover">
                          <?php 
                            $num = 0;
                            $sql = "SELECT * FROM `messages` WHERE seller = '$username'";
                            $result = $conn->query($sql);
                            $row = $result->num_rows;
                            if ($row == 0) {
                              echo "<H4 class='text-center'>You dont have any message(s)</H4>";
                            }
                            while ($messages = $result->fetch_assoc()):
                              ...
                              if (strlen($subject) > 50) {
                                ...
                                $subject = substr_replace($subject, "...", 23);
                              }
                          ?>
                            <tr class="read">
                              <td class="check"> <?php echo $number;?></td>
                              <td class="contact">
