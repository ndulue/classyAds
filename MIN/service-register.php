<?php
 include 'db_connect.php';
    ...
    $fname_err = $lname_err = $uname_err = $email_err = $number_err = $rendering_err = $description_err = $password_err = $passworda_err = $image_err = $reg_err "";
    $fname = $lname = $uname = $email = $pnumber = $rendering = $description = $password = $password_again = $picture = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (empty($_POST["rendering"] || strlen($_POST["rendering"]) < 3)) {
                $rendering_err = "Fill in your user name correctly";
            }else {
                $rendering = text_input($_POST["rendering"]);
                if (!preg_match("/^[a-zA-Z]*$/",$rendering)) {
                    $rendering_err = "Only letters and whitespaces are allowed";
                }
            }
            if (empty($_POST["description"] || strlen($_POST["description"]) < 3)) {
                $description_err = "Fill in your user name correctly";
            }else {
                $description = text_input($_POST["description"]);
                if (!preg_match("/^[a-zA-Z]*$/",$description)) {
                    $description_err = "Only letters and whitespaces are allowed";
                }
            }
            ...
            if ($num > 0) {
                ...
                if ($result) {
                    ...
                    header("location:service-register.php");
                }
                        ...
                        <form class="login-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <i class="lni-user"></i>
                                    <input type="text" id="firstname" class="form-control" name="fname" placeholder="First name" required>
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <i class="lni-user"></i>
                                    <input type="text" id="lastname" class="form-control" name="lname" placeholder="Last name" required>
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <i class="lni-user"></i>
                                    <input type="text" id="Rendering" class="form-control" name="rendering" placeholder="What service do are you rendering" required>
                                    <span class="rendering_err"><?php echo $rendering_err?></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon">
                                    <i class="lni-user"></i>
                                    <textarea class="form-control" id="description" name="description" rows="10" cols="30" required></textarea>
                                    <span class="description_err"><?php echo $description_err?></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon">
                                    ...
                                    <span class="passworrd_err"><?php echo $password_err?></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon">
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    ...
                                    <span class="picture_err"><?php echo $picture_err?></span>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <span class="reg_err"><?php echo $reg_err?></span>
                                </div>
                            </div>
